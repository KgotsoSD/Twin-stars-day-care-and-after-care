...
const fees = [
  {
    ...
    price: 'R3,500',
    period: '/month',
    features: ['Full day care (6:00am-6:00pm, Mon-Fri)', 'Meals & snacks included', 'Individual care plans', 'Daily reports', 'Sensory activities'],
  ...
  },
  {
    ...
    price: 'R3,000',
    period: '/month',
    features: ['Full day care (6:00am-6:00pm, Mon-Fri)', 'Meals & snacks included', 'Play-based learning', 'Social development', 'Creative exploration'],
  ...
  },
  {
    ...
    price: 'R2,800',
    period: '/month',
    features: ['Full day care (6:00am-6:00pm, Mon-Fri)', 'Meals & snacks included', 'School readiness program', 'Literacy & numeracy', 'Creative arts & sports'],
  ...
  },
  {
    ...
    price: 'R1,500',
    period: '/month',
    features: ['After school until 6:00pm (Mon-Fri)', 'Afternoon snack', 'Homework assistance', 'Enrichment & computer class (ages 3-15)', 'Safe, supervised environment'],
